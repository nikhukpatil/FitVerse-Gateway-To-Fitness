...
const Signup = () => {
  ...
  return (
    <>
      <Helmet>
        <title>SignUp - Fitverse</title>
      </Helmet>
      <form
        className=' w-full flex justify-center pt-16 sm:pb-32 pb-20 '
        ...
        <div className='relative flex sm:w-[450px] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md'>
