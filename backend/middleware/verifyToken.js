...
const verifyToken = (req, res, next) => {
    try {
        ...
        if (!authorizationHeader || !authorizationHeader.startsWith(`Bearer `)) {
            ...
            return next(createError(STATUS_CODES.INVALID_CODE, STATUS_MESSAGES.USER_TOKEN_NOTFOUND));
        }
        ...
        try {
            ...
            return next(createError(STATUS_CODES.INVALID_CODE, STATUS_MESSAGES.USER_TOKEN_INVALID));
        }
    } catch (error) {
